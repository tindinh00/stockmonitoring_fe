    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-[800px] h-[80vh] bg-gray-900 text-teal-400 border border-teal-500/40">
        <DialogHeader>
          ...
          <DialogDescription className="text-teal-400/80">
            Vui lòng đọc kỹ các điều khoản sau đây trước khi sử dụng dịch vụ
          </DialogDescription>
        </DialogHeader>
          ...
          <div className="space-y-6 text-teal-400/90">
            ...
            <section>
              ...
              <p>
                ...
                chúng tôi qua email: stockmonitoring@gmail.com
              </p>
            </section>
          </div>
        </ScrollArea>
